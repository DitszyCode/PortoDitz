          ...
          <div className="flex gap-x-2 px-[clamp(1.25rem,3vw,2.5rem)] text-base">
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1}
                link="https://github.com/DitszyCode"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.2}
                link="https://www.linkedin.com/in/aditya-ramadhani-0abb86410/"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.4}
                link="https://instagram.com/ditszzgrizz"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.6}
                link="https://tiktok.com/@mikaszzzz"
              />
            </MagneticEffect>
            <MagneticEffect>
              <NavMenuSocial
                ...
                classes="pr-6"
                duration={1.8}
                link="mailto:adityaramadhanikita.x13@gmail.com"
              />
            </MagneticEffect>
          </div>
