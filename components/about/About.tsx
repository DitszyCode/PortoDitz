      ...
      <div className="mx-auto flex w-[90%] flex-col items-start justify-center lg:max-w-[1212.8px]">
        ...
        <div className="mx-auto flex w-full flex-col lg:max-w-[1200px] lg:flex-row lg:gap-20">
          <div className="lg:mg-16 mb-10 flex w-full flex-col gap-4 text-[18px] font-medium leading-relaxed tracking-wide md:mb-16 md:gap-6 md:text-[20px] md:leading-relaxed lg:max-w-[90%] lg:text-base">
            <AnimateParagraph
              paragraph="Hello, my name is Aditya Ramadhani."
              delay={1.5}
            />
            <AnimateParagraph
              paragraph="I am an 11th-grade student majoring in Software Engineering (RPL) at SMKN 2 Surabaya."
              delay={1.8}
            />
            <AnimateParagraph
              paragraph="I am passionate about technology and programming, especially in web and application development."
              delay={2}
            />
            <AnimateParagraph
              paragraph="I enjoy learning new things, improving my coding skills, and exploring modern digital technologies."
              delay={2.5}
            />
          </div>
          ...
          <div className="mb-24 flex w-full flex-col gap-4 leading-relaxed tracking-wide sm:mb-32 md:mb-40 md:gap-6 md:leading-relaxed lg:mb-16 lg:max-w-[90%]">
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimateBody
                text="I use tools and technologies such as HTML, CSS, JavaScript, React, and Tailwind CSS to create responsive and modern websites."
                delay={1}
                className="text-sm"
              />
            </div>
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimateBody
                text="I also work with UI tools like Figma, Canva, and Visual Studio Code to design and build clean user interfaces."
                delay={1.5}
                className="text-sm"
              />
            </div>
            <div className="flex flex-col gap-4 md:gap-3">
              ...
              <AnimateBody
                text="For design and creativity, I use Canva and Photoshop to create simple yet attractive visual designs."
                delay={2}
                className="text-sm"
              />
            </div>
