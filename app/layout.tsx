...
export const metadata: Metadata = {
  title: {
    template: "Coding with Aditya | %s",
    default: "Coding with Aditya",
  },
  description:
    "A seasoned frontend web developer with a passion for creating engaging and interactive websites.",
  metadataBase: new URL("https://ditzy.biz.id"),
  openGraph: {
    title: {
      template: "Coding with Aditya | %s",
      default: "Coding with Aditya | Frontend Developer",
    },
    description:
      "A seasoned frontend web developer with a passion for creating engaging and interactive websites.",
    url: "https://ditzy.biz.id",
    siteName: "Coding with Aditya",
    images: [
      {
